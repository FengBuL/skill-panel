...
| AI 助手与 Diff 写回 | [ai-assistant-v3.8.1.md](./ai-assistant-v3.8.1.md) | 负责 AI Rail、API Key 检查、发送前确认、脱敏预览、取消、费用显示、diff 选择采纳和后端代理。 | 14 | 2407 | `AI Rail` `ai_optimize` `get_ai_key` `ai_cancel` `diff` `Keychain` `发送确认` |
| 设置与偏好 | [settings-v3.8.1.md](./settings-v3.8.1.md) | 负责主题、扫描、待关注规则、AI 厂商、Keychain 状态刷新、Key 保存、脱敏、diff 确认和预算设置。 | 6 | 485 | `Settings` `设置` `AI Key` `Keychain` `脱敏` `扫描目录` |
