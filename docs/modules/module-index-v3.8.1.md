...
| Skill Detail | [skill-detail-v3.8.1.md](./skill-detail-v3.8.1.md) | 负责 Skill 独立详情页、基础信息、文件结构、质量检查、依赖关系和危险操作确认提示。 | 7 | 520 | `Detail` `FileTree` `QualityCheck` `DependencyList` `DangerZone` |
