...
- [x] 发布 PR #6 已合并到 `main`，提交 `4d71c45`。
- [x] annotated tag `v3.8.3` 已创建并推送。
- [x] GitHub Release 已创建并上传发布附件。
- [x] 分支、Git 默认引用和 Obsidian 摘要完成收口。
...
| `skill-panel-v3.8.3-macos-arm64-unsigned-preview.app.zip` | `3fb0a5b4dd486573129768e1bdf26a0b5924fb321b0f0ce51ca83fce8ffd2afb` | macOS ARM 未签名 Preview |
| `skill-panel-v3.8.3-macos-arm64-unsigned-preview.dmg` | `ed2b73c66cf1bd178f2d55e2b8f349379d5625e5cf2f80bf221e8d6e3b89be94` | macOS ARM 未签名 Preview |
| `skill-panel-v3.8.3-windows-x64-setup-unverified-preview.exe` | `b0f71d3c34759a06607e8c8aacdfb5f42747f01eec43d866a20fdc9ccb01c13b` | Windows NSIS CI Preview，未人工验收 |
...
- 最终 PR 头提交已在 run `29653105230` 通过双平台 CI 并完成合并。

完整 rollback bundle 为 152.9 MB，超过 GitHub 仓库单文件 100 MB 限制。该文件不进入 Git 树，本机路径为 `/Users/shovy/Documents/Skill-Panel-Archive/releases/v3.8.3/skill-panel-v3.8.3-rollback.bundle`，已作为 GitHub Release 附件上传。

## 正式发布记录

- 发布 PR：`https://github.com/FengBuL/skill-panel/pull/6`。
- 发布合并提交：`4d71c4578dda284d1ab5c1c54ca0e1be5f10a5ba`。
- tag：`v3.8.3`。
- Release：`https://github.com/FengBuL/skill-panel/releases/tag/v3.8.3`。
- 最终 PR CI：run `29653105230`，双平台通过。
- main push CI：run `29653488657`，双平台通过。
- 分支状态：本地和远端只保留 `main`，默认引用均为 `main`。
- 清理前 bundle：`/Users/shovy/Documents/Skill-Panel-Archive/git-bundles/pre-v3.8.3-branch-cleanup-20260719.bundle`。
- 清理前 bundle SHA256：`67fe996548eb8095bbf92ca7c41f46e4b22a9a19ad9c9f55304a4c5266344a76`。
